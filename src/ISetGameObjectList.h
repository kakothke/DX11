...
public:
	...
	virtual void instanceToCamera(BaseCamera* aObject, const int& aLayer = 0) = 0;
	...
	virtual BaseCamera* findCameraGameObject(const GameObjectTag& aTag) = 0;
	...
	virtual std::vector<BaseCamera*> findCameraGameObjects(const GameObjectTag& aTag) = 0;
